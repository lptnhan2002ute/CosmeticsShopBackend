...
import { AdminLayout, ManageOrder, ManageProduct, ManageUser, CreateProduct, Dashboard, ManageCategory, AdminPersonnal, Messenger, ManageVoucher, Flashsale, ManageNotification } from './pages/admin';
    ...
    <div className="font-main h-screen">
      ...
      <Routes>
        ...
        <Route path={path.ADMIN} element={<AdminLayout />}>
          ...
          <Route path={path.NOTIFICATION} element={<ManageNotification />} />
