...
const UpdateProduct = ({ brand, editProduct, render, setEditProduct }) => {
    ...
    useEffect(() => {
        ...
        console.log("brand", editProduct?.brand?._id)
        console.log("brand", editProduct)
    }, [editProduct])

    const { register, formState: { errors }, reset, setValue, handleSubmit, setError } = useForm()
