...
const ProductCard = ( {price, title, totalRatings, image, category, id}) => {
    return (
        <Link to={`/${category}/${id}/${title}`} className='w-1/3 flex-auto px-[10px] mb-[20px]'>
            <div className='flex w-full border'>
            <img src={ image } alt='products' className='w-[120px] h-[120px] object-contain p-4'/>
